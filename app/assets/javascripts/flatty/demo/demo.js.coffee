$(document).ready ->
  ...
  $("#notification1").live "click", (e) ->
    $.jGrowl("Lorem ipsum dolor sit amet...");
    return false

  $("#notification2").live "click", (e) ->
  ...
  $("#comments-more-activity").live "click", (e) ->
    $(this).button("loading")
    setTimeout (->
  ...
  $("#users-more-activity").live "click", (e) ->
    $(this).button("loading")
    setTimeout (->
  ...
  $(".todo-list .important").live "click", (e) ->
